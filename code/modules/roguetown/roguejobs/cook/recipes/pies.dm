...
//God bless whoever struggled with this mess of pies. I genuinely hope the filling code works because it looks nifty. I am now going to create six fucking varieties of pie. Satan preserve my soul.
...
/datum/crafting_recipe/roguetown/cooking/cabbagepie
	name = "cabbage pie"
	reqs = list(
		/obj/item/reagent_containers/food/snacks/grown/cabagge = 3,
		/obj/item/reagent_containers/food/snacks/rogue/piedough = 1)
	parts = list(
...
/datum/crafting_recipe/roguetown/cooking/almondpie
	name = "almond pie"
	reqs = list(
		/obj/item/reagent_containers/food/snacks/grown/almond = 3,
		/obj/item/reagent_containers/food/snacks/rogue/piedough = 1)
	parts = list(
		/obj/item/reagent_containers/food/snacks/grown/almond = 3)
	result = /obj/item/reagent_containers/food/snacks/rogue/pie/almond

/obj/item/reagent_containers/food/snacks/rogue/pie/cooked/almond
	name = "almond pie"
	desc = ""
	list_reagents = list(/datum/reagent/consumable/nutriment = 30)
	eat_effect = /datum/status_effect/buff/foodbuff
...
/obj/item/reagent_containers/food/snacks/rogue/pie/almond
	name = "almond pie"
	cooked_type = /obj/item/reagent_containers/food/snacks/rogue/pie/cooked/almond
	eat_effect = /datum/status_effect/debuff/uncookedfood

//Putting this as a barrier for my own sanity. The original code is split in a weird way so I'm just... keeping this all neat and tidy in the cozy box.
